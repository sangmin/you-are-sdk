...
import com.github.sjones4.youcan.youdisco.model.ServiceAccount;
    ...
    while (true) {
      ...
      if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
        if (context.testExpression("Alias", targetDepth)) {
          serviceAccount.setAlias( SimpleTypeStaxUnmarshallers.StringStaxUnmarshaller.getInstance().unmarshall( context ) );
          continue;
        }
        if (context.testExpression("Account", targetDepth)) {
          serviceAccount.setAccount( SimpleTypeStaxUnmarshallers.StringStaxUnmarshaller.getInstance().unmarshall( context ) );
          continue;
        }
        if (context.testExpression("CanonicalId", targetDepth)) {
